...
namespace MauiBookStoreServer.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update MauiBookStoreServerDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update MauiBookStoreServerEfCoreEntityExtensionMappings to extend the IdentityUser entity
