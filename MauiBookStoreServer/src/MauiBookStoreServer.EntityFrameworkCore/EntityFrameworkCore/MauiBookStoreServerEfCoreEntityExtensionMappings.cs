...
{
    public static class MauiBookStoreServerEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE MauiBookStoreServerModuleExtensionConfigurator CLASS (in the Domain.Shared project)
