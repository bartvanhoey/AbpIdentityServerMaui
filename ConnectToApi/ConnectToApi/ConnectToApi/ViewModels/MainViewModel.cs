...
using ConnectToApi.Services;
using JetBrains.Annotations;
using Xamarin.Essentials;
using Xamarin.Forms;

namespace ConnectToApi.ViewModels
{
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        {
            _oidcIdentityService = new OidcIdentityService(App.ClientId, App.RedirectUrl, App.PostLogoutRedirectUrl, App.Scopes, App.AuthorityUrl, App.ClientSecret);
